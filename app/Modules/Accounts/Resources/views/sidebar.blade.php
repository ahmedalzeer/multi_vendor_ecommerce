@component('dashboard::layouts.components.sidebarItem')
    @slot('can', ['ability' => 'viewAny', 'model' => \App\Modules\Accounts\Entities\User::class])
    ...
    @slot('tree', [
        ...
        [
            ...
            'can' => ['ability' => 'create', 'model' => \App\Modules\Accounts\Entities\ShippingCompanyOwner::class],
